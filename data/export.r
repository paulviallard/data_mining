...
dataset.export = function() {
  ...
  if(!file.exists(dataset.file)) {
    ...
    # If there are a file, we read it
...
dataset.file = "dataset/Understanding/proba_champs.csv"
...
dataset.file = "dataset/Understanding/proba_bans.csv"
...
dataset.file = "dataset/Understanding/proba_player_stats.csv"
...
dataset.file = "dataset/Understanding/proba_team_stats.csv"
...
dataset.file = "dataset/Understanding/proba_role.csv"
...
dataset.file = "dataset/Understanding/proba_basket.csv"
...
dataset.file = "dataset/Understanding/proba_ban_basket.csv"
